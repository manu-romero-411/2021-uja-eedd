...
private:
    int id;
    UTM direccion;
    list <TarjetaVacunacion*> listaTarjetas;
...
public:
    ...
    void anadirTarjetaLista(TarjetaVacunacion* nuevo); //Añade un usuario a la lista de vacunacion
    bool administrarDosis(TarjetaVacunacion* vacunando, nombreFabricante tipo); //Administra una dosis a un usuario
